...
const credentials = {
  chromium: { username: process.env.CHROME_USER, password: process.env.CHROME_PASSWORD, },
  firefox: { username: process.env.FIREFOX_USER, password: process.env.FIREFOX_PASSWORD },
